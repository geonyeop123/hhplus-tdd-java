...
class PointServiceTest {
    ...
    class charge {
        ...
        void success() {
            ...
            when(lockManager.getLock(id)).thenReturn(new ReentrantLock());
            doNothing().when(lockManager).unLock(any(), anyLong());
            ...
            verify(pointHistoryService, times(1)).insert(anyLong(), anyLong(), any(), anyLong());
            verify(lockManager, times(1)).getLock(id);
            verify(lockManager, times(1)).unLock(any(), anyLong());
